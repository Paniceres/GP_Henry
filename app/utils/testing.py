...
'''states = data_frames.get('1_states.parquet.gz')
...
df_ry = data_frames.get('10_reviews_yelp.parquet.gz')
df_user = data_frames.get('user_categories.parquet') 
df_categories = data_frames.get('locales_categories.parquet')'''
...
recommendation = print(get_recommendation(business_google=business_google,business_yelp=business_yelp,df_user=df_user,df_categories=df_categories,states=states,df_rg=df_rg,df_ry=df_ry,category='georgian'))
